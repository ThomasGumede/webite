...
function Collab() {
    return (
        <div className="md:flex justify-between items-center space-y-9 my-16">
            <img src='/img/Telecommuting-amico.svg' alt="" className="w-[400px] h-[400px] md:w-[500px] md:h-[500px]" />

            <div className="space-y-6">
                <h2 className='bg-[#ebe7ff] py-2 px-4 font-semibold text-base w-max text-[#8a6eff] rounded-md'>Collaborate Better</h2>
                <h1 className="text-[#1e2472] font-bold text-3xl">There are lot of feature insights</h1>

                <div className="space-y-3 w-[300px] md:w-[400px]">
