...
function Services() {
    return (
        <div className="space-y-5 mt-11">
            <h2 data-aos="fade-right" className='bg-[#ebe7ff] py-2 px-4 font-semibold text-base w-max text-[#8a6eff] rounded-md'>Services</h2>
            <div data-aos="fade-right" className="flex flex-col space-y-4 md:flex-row md:justify-between">
                ...
                <h2 data-aos="fade-left" className="py-2 px-4 text-center font-semibold text-base w-max h-11 text-[#8a6eff] rounded-md border-2 border-[#8a6eff]">Explore More</h2>
            </div>
